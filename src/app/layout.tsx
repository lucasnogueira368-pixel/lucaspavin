...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Landing pages profissionais que convertem visitantes em clientes',
    url: SITE_URL,
    siteName: 'Lucas Pavin',
    locale: 'pt_BR',
    type: 'website',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Lucas Pavin - Desenvolvedor Web' }],
  },
  twitter: {
